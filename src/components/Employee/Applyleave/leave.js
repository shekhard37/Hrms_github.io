    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          <h2 className="text-center m-4">Grievance complaint</h2>

          <form onSubmit={(e) => onSubmit(e)}>
            <div className="mb-3">
              <label htmlFor="session_year" className="form-label"> Employee Name :</label>
            ...
            <div className="mb-3">
              <label htmlFor="semester" className="form-label"> Message issue:  </label>
              
            <input  type={"text"}className="form-control"placeholder="Write Your complain"name="semester"value={semester}   onChange={(e) => onInputChange(e)}  />
            </div>
            <div className="mb-3">
