      ...
      <div className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          ...
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="mb-3">
              <label htmlFor="semester" className="form-label"> Message:  </label>
              
            <input  type={"text"}className="form-control"placeholder="Write Your complaint"name="semester"value={semester}   onChange={(e) => onInputChange(e)}  />
            </div>
            <div className="mb-3">
