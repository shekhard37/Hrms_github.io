...
class LogIn extends React.Component {
  ...
  render() {
    const myStyle = {
      backgroundImage:
        "url('https://png.pngtree.com/background/20210710/original/pngtree-colorful-watercolor-rainbow-background-picture-image_985725.jpg')",
      height: '100vh',
      marginTop: '-1px',
      fontSize: '25px',
            ...
            <div className="container mt-2 mb-4 divMiddle">
              <div className="col-sm-8 ml-auto mr-auto">
                ...
                >
                  ...
                  >
                    <div className="col-sm-12 border border-success shadow rounded pt-2">
